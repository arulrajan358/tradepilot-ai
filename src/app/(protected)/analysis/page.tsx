...
export default function AnalysisPage() {
    // Mock Data for "Prop Firm" Analysis
    const analytics = {
        avgRiskPerTrade: "1.2%",
        maxDrawdown: "-3.5%",
        profitFactor: "2.1",
        ...
        passedAccounts: 1,
        failedAccounts: 0,
        equityCurve: [10000, 10100, 10050, 10200, 10350, 10300, 10500], // Simple data for visualization if we had a chart
    };

    return (
        <div className="space-y-6 pb-8">
            <h2 className="text-2xl font-bold text-white mb-6">Prop Firm Analysis</h2>

            {/* Account Health Section */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card className="bg-brand-slate border-slate-800 p-6 flex items-center justify-between">
                    <div>
